...
# Train
# python train.py --attack=none --attack_init=zero --attack_iters=50 --n_restarts=10 --eps=8 --epochs=96 --eval_iter_freq=200 --batch_size=256 --batch_size_eval=1024 --grad_input_sum_coeff=10 --eval_early_stopped_model --n_final_eval=-1 --seed=0
# FGSM
...
# PGD-AT
# python train.py --attack=pgd --pgd_alpha_train=10 --pgd_train_n_iters=2 --attack_iters=50 --n_restarts=10 --eps=16  --attack_init=zero --epochs=96 --batch_size=256 --eval_iter_freq=200 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --seed=0
...
# python train.py --attack=fgsm --fgsm_alpha=1.0 --attack_iters=50 --n_restarts=10 --eps=8 --attack_init=zero --epoch=96 --eval_iter_freq=200 --batch_size=256 --grad_align_cos_lambda=21  --lr_max=0.04 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --seed=0
...
# python train.py --attack=fgsm --attack_init=zero --discrete_eps --fgsm_alpha=1.0 --attack_iters=50 --n_restarts=10 --eps=8 --epoch=96 --eval_iter_freq=200 --batch_size=256 --grad_input_sum_coeff=10 --grad_align_cos_lambda=0.0 --lr_max=0.06 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --start_eval_epoch=0 --seed=0
...
# python train.py --attack=fgsm --attack_init=zero --discrete_eps --fgsm_alpha=1.0 --attack_iters=50 --n_restarts=10 --eps=8 --epoch=96 --eval_iter_freq=200 --batch_size=256 --grad_input_sum_coeff=0.0 --grad_align_cos_lambda=0.0 --lr_max=0.04 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --start_eval_epoch=0 --seed=0
# FGSM+GradSum-AT
# python train.py --attack=fgsm --attack_init=zero --fgsm_alpha=1.0 --attack_iters=50 --n_restarts=10 --eps=8 --epoch=96 --eval_iter_freq=200 --batch_size=256 --grad_input_sum_coeff=5 --grad_align_cos_lambda=10.0 --lr_max=0.04 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --start_eval_epoch=0 --seed=0
python train.py --attack=fgsm --attack_init=zero --fgsm_alpha=1.0 --attack_iters=50 --n_restarts=10 --eps=8 --epoch=8 --eval_iter_freq=200 --batch_size=256 --grad_input_sum_coeff=5 --grad_align_cos_lambda=10.0 --lr_max=0.04 --load_model=085627 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --start_eval_epoch=0 --seed=0
# FGSM+GradAlign-AT
# python train.py --attack=fgsm --attack_init=zero --fgsm_alpha=1.0 --attack_iters=50 --n_restarts=10 --eps=16 --epoch=96 --eval_iter_freq=200 --batch_size=256 --grad_input_sum_coeff=0.0 --grad_align_cos_lambda=20 --lr_max=0.04 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --start_eval_epoch=0 --seed=0
# FGSM+MSAT-AT
