...
# Train
# python train.py --attack=none --attack_init=zero --attack_iters=50 --n_restarts=10 --eps=16 --epochs=96 --eval_iter_freq=200 --dataset=cifar100 --batch_size=256 --batch_size_eval=1024 --lr_max=0.04 --eval_early_stopped_model --n_final_eval=-1 --seed=0
# FGSM
python train.py --attack=fgsm --eps=8  --attack_init=zero --attack_iters=50 --n_restarts=10 --epochs=96 --eval_iter_freq=200 --dataset=cifar100 --batch_size=256 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --seed=1998
# PGD-AT
# python train.py --attack=pgd --pgd_alpha_train=2 --pgd_train_n_iters=4 --attack_iters=50 --n_restarts=10 --eps=8  --attack_init=zero --epochs=96 --batch_size=256 --eval_iter_freq=200 --dataset=cifar100 --batch_size_eval=1024  --eval_early_stopped_model --n_final_eval=-1 --seed=0
# python train.py --attack=pgd --pgd_alpha_train=1 --pgd_train_n_iters=8 --pgd_alpha=2 --attack_iters=50 --n_restarts=10 --eps=8  --attack_init=zero --epochs=96 --batch_size=256 --eval_iter_freq=200 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --seed=0
# PGD+GIS-10, eps=8
...
# FGSM+GradSum-AT
# python train.py --attack=fgsm --attack_init=zero --fgsm_alpha=1.0 --attack_iters=50 --n_restarts=10 --eps=8 --epoch=96 --eval_iter_freq=200 --batch_size=256 --grad_input_sum_coeff=9 --grad_align_cos_lambda=0.0 --lr_max=0.04 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --start_eval_epoch=0 --seed=0 --dataset=cifar100
# python train.py --attack=fgsm --attack_init=random --fgsm_alpha=1.0 --attack_iters=50 --n_restarts=10 --eps=8 --epoch=96 --eval_iter_freq=200 --batch_size=256 --grad_input_sum_coeff=12 --grad_align_cos_lambda=0.0 --lr_max=0.04 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --start_eval_epoch=0 --seed=0 --dataset=cifar100
...
# FGSM+GradAlign-AT
# python train.py --attack=fgsm --attack_init=zero --fgsm_alpha=1.0 --attack_iters=50 --n_restarts=10 --eps=8 --epoch=96 --eval_iter_freq=200 --batch_size=256 --grad_input_sum_coeff=0.0 --grad_align_cos_lambda=20 --lr_max=0.04 --batch_size_eval=1024 --eval_early_stopped_model --n_final_eval=-1 --start_eval_epoch=0 --seed=0 --dataset=cifar100
# FGSM+MSAT-AT
