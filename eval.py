...
def get_args():
    ...
    parser.add_argument('--dataset', default='cifar10', choices=['mnist', 'svhn', 'cifar10', 'cifar10_binary', 'cifar10_binary_gs', 'uniform_noise', 'imagenet', 'tiny_imagenet'], type=str)
...
def main():
    ...
    for label in args.model_labels:
        ...
        if args.naive_eval:
            test_acc_clean, _, _ = utils.rob_acc(test_batches, model, eps, eps, opt, half_prec, 0, 1, rs=False)
